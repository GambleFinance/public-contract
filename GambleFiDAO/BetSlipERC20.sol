...
contract Betslip is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Bet-Slip", "BETSLIP", 9) ERC20Permit() {
    ...
    /**
        @notice increases BETSLIP Token supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess BETSLIP
